<!-- CNT branch: corrections | read before acting in every session -->
<!-- Records past AI mistakes on this project. Never delete entries. Only add. -->

## Corrections Log

> Format: `YYYY-MM-DD | [category] what went wrong | correct approach`

<!-- Add entries below when an AI assistant makes a mistake on this project. -->
<!-- Examples:
