...
- C:\workspace\claude\forgecraft-mcp\CLAUDE.md
- C:\workspace\claude\forgecraft-mcp\docs\PRD.md
- C:\workspace\claude\forgecraft-mcp\docs\use-cases.md
...
You are starting the first implementation session for **Generative Specification Framework**.
